...
using MCMCDiffusion, DynamicalBilliards, JLD, LsqFit


function costmcmc(to, nsimulations, mean_value; prec = 10.^-1., 
                  D = 0.17, beta = -1.)
    ...
    #Estimate mean with the highest number of samples
